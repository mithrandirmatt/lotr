...
description: 'A repository-scoped custom agent template. Edit `name`, `description`,
  `tools`, and `prompts`.
...
- name: gpt-5-mini
  ...
  parameters:
    temperature: 0.2
prompts:
  system: 'You are a helpful, safety-conscious assistant for this repository. When
